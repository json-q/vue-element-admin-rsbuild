> Migrado de vue-cli a [rsbuild](https://v1.rsbuild.rs/) para una mejor experiencia de desarrollo, sin romper el entorno de desarrollo actual, solo requiere Node.js >= 16.10.0.
